...
Поскольку требуемый набор функций небольшой, а формулировка задачи не содержит 
информации по целевой платформе и будущим дополнениям, то и реализация сделанна проще, безопаснее и быстрее.
