...
Программа производит обработку ввода, включая проверку синтаксиса на соответствие правилам построения математического выражения, пошаговую компиляцию в обратную польскую запись и интерпретацию.
